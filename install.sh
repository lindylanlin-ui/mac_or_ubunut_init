...
# tuffy 工作使用
#brew_tap_array=("hashicorp/tap" "k8sgpt-ai/k8sgpt" "common-fate/granted")
#brew_array=("zsh" "bash-completion" "watch" "kubernetes-cli" "kustomize" "helm" "hashicorp/tap/terraform" "terragrunt" "kubectx" "jq" "k9s" "shellcheck" "wget" "telnet" "tree" "k6" "fzf" "kubent" "pv" "dialog" "ipcalc" "yq" "helmfile" "node" "go" "webp") # 套件
#brew_cask=("google-chrome" "iterm2" "visual-studio-code" "docker" "raycast" "notion" "google-cloud-sdk" "openvpn-connect" "drawio") # 視窗程式

# tuffy一般使用
brew_tap_array=()
brew_array=("zsh" "bash-completion" "jq" "shellcheck" "wget" "telnet" "tree" "fzf" "pv" "dialog" "yq" "webp") # 套件
brew_cask=("google-chrome" "iterm2" "visual-studio-code" "raycast" "openvpn-connect" "wireguard" "drawio") # 視窗程式
...
PROFILE_FILE="new_tuffy_iterm2_setting.json"
# 從 JSON 檔案中讀取 GUID
