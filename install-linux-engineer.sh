...
apt_prereq_array=("curl" "git" "ca-certificates" "gnupg" "lsb-release" "software-properties-common" "nodejs" "npm" "bc" "vim")
apt_array=("zsh" "bash-completion" "wget" "curl" "git" "jq" "tree" "telnet" "ca-certificates" "gnupg" "lsb-release" "software-properties-common" "fzf" "dialog" "bc" "vim" "ipcalc" "shellcheck" "hugo" "golang-go" "nodejs" "npm" "autojump" "kubectx" "wireguard" "openvpn" "network-manager-openvpn-gnome")
